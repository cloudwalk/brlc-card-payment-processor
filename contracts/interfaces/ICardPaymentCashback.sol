...
interface ICardPaymentCashbackPrimary is ICardPaymentCashbackTypes {
    ...
    /**
     * @dev Resends the cashback for a given authorization ID with a new cashback rate.
     *
     * The new cashback nonce will be generated by the cashback distributor smart contract.
     *
     * Emits a {SendCashbackSuccess} event if the cashback is successfully sent.
     *
     * @param authorizationId The card transaction authorization ID from the off-chain card processing backend.
     * @param cashbackRateInPermil The cashback rate in permil to send.
     */
    function resendCashback(bytes16 authorizationId, int256 cashbackRateInPermil) external;
